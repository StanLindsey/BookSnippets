...
if (Books.find().count() === 0) {
    ...
    Books.insert({
        ...
        editorsPicks: false,
        live: true,
        categories: ["Childrens", "Adventure", "Fantasy"]
    });
    ...
    Books.insert({
        ...
        editorsPicks: false,
        live: true,
        categories: ["Historical", "Drama", "Humour"]
    });
